 ...
 */
fun bold(opt: EasyStringBuilder.() -> Unit) = "**${EasyStringBuilder().apply(opt)}**"
 ...
 */
fun italic(opt: EasyStringBuilder.() -> Unit) = "*${EasyStringBuilder().apply(opt)}*"
 ...
 */
fun underline(opt: EasyStringBuilder.() -> Unit) = "__${EasyStringBuilder().apply(opt)}__"
 ...
 */
fun code(opt: EasyStringBuilder.() -> Unit) = "`${EasyStringBuilder().apply(opt)}`"
 ...
 */
fun codeBlock(language: String = "", opt: EasyStringBuilder.() -> Unit) = "```$language\n${EasyStringBuilder().apply(opt)}```"
