...
class CommandFlagDelegate<T>(private val name: String? = null, private val default: () -> T) :
    ReadWriteProperty<Command, T> {

    constructor(name: String? = null, default: T) : this(name, { default })

    override fun getValue(thisRef: Command, property: KProperty<*>): T =
        thisRef.flags[name ?: property.name] as? T ?: default()
