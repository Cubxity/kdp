...
package dev.cubxity.kdp.engine.jda.event.guild
...
import dev.cubxity.kdp.engine.jda.event.JDAEvent
import net.dv8tion.jda.api.events.guild.GenericGuildEvent

@KDPUnsafe
interface JDAGuildEvent : JDAEvent, GuildBehaviorHolder {
    override val event: GenericGuildEvent
